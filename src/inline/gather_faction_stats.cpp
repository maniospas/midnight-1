...
for (int i = 0; i < num_units; i++) {
    ...
    if(!u.speed) continue;
    if(u.texture!=&tex::kraken && u.texture!=&tex::hog && u.texture!=&tex::bison && u.texture!=&tex::wolf && u.texture!=&tex::rat && u.texture!=&tex::snowman && u.texture!=&tex::roomba) { // don't count animals or roombas for industry needs'
        u.faction->count_members += u.max_health/5.f;
